...
@interface PickUpVC : BaseVC<MKMapViewDelegate,CLLocationManagerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UITextFieldDelegate,GMSMapViewDelegate>
{
...
@property (strong, nonatomic) IBOutlet UIView *viewGoogleMap;
