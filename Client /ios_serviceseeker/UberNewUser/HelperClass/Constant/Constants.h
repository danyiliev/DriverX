...
#define API_URL @"http://52.26.46.37/user/"//Live
#define SERVICE_URL @"http://52.26.46.37/"

#define Address_URL @"https://maps.googleapis.com/maps/api/geocode/json?"
#define PRIVACY_URL @"http://52.26.46.37/terms.html"
...
extern NSString *const SEGUE_TO_GET_PROVIDERS;
...
extern NSString *const FILE_CREATE_REQUEST_PROVIDERS;
extern NSString *const FILE_DELETE_CARD_TOKEN;
