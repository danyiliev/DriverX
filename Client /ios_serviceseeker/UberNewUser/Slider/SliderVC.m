...
{
    [super viewDidLoad];
    arrSlider=[[NSMutableArray alloc]initWithObjects:@"PROFILE",@"HISTORY",@"PAYMENT",nil ];//@"Promotions",@"Logout", nil];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"LOGOUT" message:@"Are Sure You Want to Log Out" delegate:self cancelButtonTitle:@"NO" otherButtonTitles:@"YES", nil];
        alert.tag=100;
        [alert show];
